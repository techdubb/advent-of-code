...
sleepiest_guard_id = max(sleepy_data, key=sleepy_data.get)

sleepy_minute = find_sleepy_minute(analysis)
sleepiest_minute = max(sleepy_minute[sleepiest_guard_id], key=sleepy_minute[sleepiest_guard_id].get)

print "sleepy guard: " + sleepiest_guard_id[1:]
print "sleepy minute: " + str(sleepiest_minute)

print sleepiest_minute * int(sleepiest_guard_id[1:])
